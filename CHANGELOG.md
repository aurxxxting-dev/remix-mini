...
#### 打包产物
- `Remix Mini Setup 1.3.5.exe` - NSIS 安装包
...
| 变更 | 说明 |
|------|------|
| 手动检测更新 | 版本号旁新增刷新按钮，点击可手动检测更新 |
| 更新状态提示 | 检测/下载过程中在标题栏显示实时状态 |

#### 打包产物
- `Remix Mini Setup 1.3.4.exe` - NSIS 安装包（已发布到 GitHub Release）
...
| 变更 | 说明 |
|------|------|
| 余额显示格式 | 去掉"余额:"中文前缀，改为 ¥ 符号（如 ¥19.64、¥∞） |

#### 打包产物
- `Remix Mini Setup 1.3.3.exe` - NSIS 安装包（已发布到 GitHub Release）
